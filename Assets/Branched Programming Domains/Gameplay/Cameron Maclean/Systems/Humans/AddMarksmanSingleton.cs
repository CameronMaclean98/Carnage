...
public class AddMarksmanSingleton : MonoBehaviour, IConvertGameObjectToEntity
{
    public float unitspeed = 60.0f;
    public int teamnum;
...
*/
        ...
        var tag = new TagMarksman
        {
        };
        dstManager.AddComponentData(entity, tag);

        var tag2 = new TagRangeUnit
        {
