...
public class FermundSpellCastSystem : JobComponentSystem
{
 ...
 /*
  * THis spell will be added if time permits
    ...
    */
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        ...
        timer.WSpellTimer += Time.deltaTime;
        SetSingleton<SingletonSpellCoolDown>(timer);

        if (keyboard.selectedSpell == KeyCode.W && timer.WSpellTimer > timer.WSpellMaxTimer)
        {
