...
public class CebilAttackBannerSystem : JobComponentSystem
{
    ...
    struct LegionnaireLocationsJob : IJobForEachWithEntity<Translation, Range, Rate>
    {
        public NativeArray<float3> bannerLocation;
        public NativeArray<bool> bannerDestroyed;
        public void Execute(Entity entity, int index, ref Translation location, ref Range range, ref Rate rate)
        {
    ...
    [ExcludeComponent(typeof(CebilGlobalBuff))]
    struct MarksmanLocationsJob : IJobForEachWithEntity<Translation, Range, Rate>
    {
        public NativeArray<float3> bannerLocation;
        public NativeArray<bool> bannerDestroyed;
        public void Execute(Entity entity, int index, ref Translation location, ref Range range, ref Rate rate)
    ...
    [ExcludeComponent(typeof(CebilGlobalBuff))]
    struct PaladinLocationsJob : IJobForEachWithEntity<Translation, Range, Rate>
    {
        public NativeArray<float3> bannerLocation;
        public NativeArray<bool> bannerDestroyed;
        public void Execute(Entity entity, int index, ref Translation location, ref Range range, ref Rate rate)
    ...
    [ExcludeComponent(typeof(CebilGlobalBuff))]
    struct KnightLocationsJob : IJobForEachWithEntity<Translation, Range, Rate>
    {
    ...
    [ExcludeComponent(typeof(CebilGlobalBuff))]
    struct SpellslingerLocationsJob : IJobForEachWithEntity<Translation, Range, Rate>
    {
        public NativeArray<float3> bannerLocation;
        public NativeArray<bool> bannerDestroyed;
        public void Execute(Entity entity, int index, ref Translation location, ref Range range, ref Rate rate)
    ...
    [ExcludeComponent(typeof(CebilGlobalBuff))]
    struct GryphonLocationsJob : IJobForEachWithEntity<Translation, Range, Rate>
    {
        public NativeArray<float3> bannerLocation;
        public NativeArray<bool> bannerDestroyed;
        public void Execute(Entity entity, int index, ref Translation location, ref Range range, ref Rate rate)
