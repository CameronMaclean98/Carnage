...
public class FermundsHealingWardSystem : JobComponentSystem
{
    ...
    struct LegionnaireLocationJob : IJobForEachWithEntity<Translation, Health>
    {
    ...
    [ExcludeComponent(typeof(TagEnemyUnit))]
    struct MarksManLocationJob : IJobForEachWithEntity<Translation, Health>
    {
    ...
    [ExcludeComponent(typeof(TagEnemyUnit))]
    struct PaladinLocationJob : IJobForEachWithEntity<Translation, Health>
    {
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        ...
        if (WardLocation[0].x != 0 && WardLocation[0].y != 0 && WardLocation[0].z != 0)
        {
            ...
            var legionnaireToHeal = new PaladinLocationJob
            {
                wardLocation = WardLocation,
                DeltaTime = Time.deltaTime
            }.ScheduleSingle(this, inputDeps);
